        ...
        <>
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-4">
                    ...
                    <button
                        className="flex lg:hidden p-2 text-gray-500 hover:text-gray-800 rounded-lg hover:bg-gray-100 transition-colors"
                    ...
                    <div className="flex items-center gap-3">
                        <div className="hidden sm:flex items-center gap-1.5 bg-orange-50 text-orange-500 rounded-full px-2.5 py-1 text-sm font-semibold">
                            <Flame className="w-4 h-4" />
                            <span>{currentStreak}</span>
                        </div>

                        <div className="hidden sm:flex items-center gap-1.5 bg-[var(--forest-50)] text-[var(--forest-600)] rounded-full px-2.5 py-1 text-sm font-semibold">
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="block lg:hidden fixed left-0 right-0 bg-white border-b border-[var(--border)] shadow-lg z-30 p-3"
                    ...
                    >
                        {navLinks.map(link => (
                            <button
                                ...
                                className={`block w-full text-left px-4 py-3 rounded-xl text-sm font-medium mb-1 transition-colors ${activeTab === link.id
