...
interface QuickActionsProps {
  ...
  setProfileSection: (section: "overview" | "achievements" | "settings" | "notes") => void;
      ...
      <div className="grid grid-cols-2 gap-3">
        {actions.map((action) => (
          <button
            ...
            className={`${action.color} rounded-xl p-4 text-left shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 active:scale-95`}
          >
