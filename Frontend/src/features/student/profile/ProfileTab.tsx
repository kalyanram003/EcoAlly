        ...
        <div className="lg:col-span-1 space-y-4">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4">
                <div className="text-center bg-white/10 rounded-xl p-3 backdrop-blur-sm">
                  <div className="text-base sm:text-xl">{userProfile.totalPoints.toLocaleString()}</div>
                ...
                >
                  <div className="text-base sm:text-xl">#{userProfile.rank}</div>
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="text-base sm:text-xl">{userProfile.currentStreak}</span>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-[var(--border)] shadow-[var(--shadow-xs)] overflow-hidden p-2">
            <div className="relative lg:static">
              ...
              <div className="lg:hidden absolute right-0 top-0 bottom-2 w-8 bg-gradient-to-l from-white pointer-events-none z-10" />
              <div className="flex gap-2 overflow-x-auto pb-2 lg:flex-col lg:overflow-visible [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                <button
