...
export function SignUpPage({ onSignUp, onBackToLogin }: SignUpPageProps) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* ── RIGHT FORM PANEL ── */}
      <div className="flex-1 flex flex-col items-center justify-center bg-[var(--bg-base)] px-4 py-6 sm:px-6 sm:py-10 lg:px-12 xl:px-16 overflow-y-auto">
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <div className="flex bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`flex-1 py-2 px-3 rounded-md text-sm font-medium transition-colors ${signupMethod === "email"
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-3 rounded-md text-sm font-medium transition-colors ${signupMethod === "phone"
                      ? "bg-white text-[var(--forest-600)] shadow-sm"
                      : "text-gray-600 hover:text-gray-800"
                    }`}
                >
